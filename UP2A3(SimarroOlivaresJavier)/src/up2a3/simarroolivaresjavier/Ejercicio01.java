...
public class Ejercicio01 {
    ...
    public static void main(String[] args){                                                                                                         // Creamos el método
        ...
        double total = precioCuenta + precioCuenta*porcentajePropina/100;                                                                           // Calcular la propina a entregar y cargarla en total.      
        ...
        System.out.printf("\n\nDa como resultado un total de %.2f€ a pagar\n\n\n",total);                                                           // Mensaje de salida final con calculo e impresión del procentaje de propina para los datos introducidos.
